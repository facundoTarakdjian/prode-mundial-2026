...
// ── Orden del árbol del bracket (cuadro oficial FIFA 2026) ───────────────
// Mitad izquierda: R32 → R16 → QF → SF (de arriba a abajo)
// Pares: [0,1]→R16_1, [2,3]→R16_2, [4,5]→R16_5, [6,7]→R16_6 → QF_1,QF_2 → SF_1
const L_R32 = ['R32_3','R32_6','R32_1','R32_4','R32_12','R32_11','R32_10','R32_9']
const L_R16 = ['R16_1','R16_2','R16_5','R16_6']
const L_QF  = ['QF_1','QF_2']
const L_SF  = ['SF_1']

// Mitad derecha: SF → QF → R16 → R32 (de arriba a abajo, espejo)
// Pares: [0,1]→R16_3, [2,3]→R16_4, [4,5]→R16_7, [6,7]→R16_8 → QF_3,QF_4 → SF_2
const R_SF  = ['SF_2']
const R_QF  = ['QF_3','QF_4']
const R_R16 = ['R16_3','R16_4','R16_7','R16_8']
const R_R32 = ['R32_2','R32_5','R32_7','R32_8','R32_15','R32_14','R32_13','R32_16']
